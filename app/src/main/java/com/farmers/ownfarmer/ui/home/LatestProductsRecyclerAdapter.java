...
import com.farmers.ownfarmer.ui.home.DataModel.HomeProductsDataModel;
...
class LatestProductsRecyclerAdapter extends RecyclerView.Adapter<LatestProductsRecyclerAdapter.MyViewHolder>  {


    Activity activity;
    private List<HomeProductsDataModel> productsDataModel;

    public LatestProductsRecyclerAdapter(Activity activity, List<HomeProductsDataModel> productsDataModel) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(activity).inflate(R.layout.latest_products_recycler_item , parent , false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull final View itemView) {
            ...
            ///////// initializing
            productImage_IV = itemView.findViewById(R.id.on_sale_iv);
            productName_TV = itemView.findViewById(R.id.on_sale_products_title_tv);
            productPrice_TV = itemView.findViewById(R.id.on_sale_product_price_tv);
            viewDetail_BTN = itemView.findViewById(R.id.add_cart_button);
